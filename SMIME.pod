...
or at least one public key is tainted.
...
Get all X.509 certificates (and CRLs, if any) included in S/MIME message or
PKCS#7 object $data.  Optional $type parameter may specify type of data:
